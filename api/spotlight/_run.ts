...
// Demo candidates (Replace with dynamic data in production)
const CANDIDATES = [
...
// Function to pick a winner deterministically based on the seed
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  // Handle CORS for local dev (UI on 5173)
  ...
  // Send the response with the winner and credits granted
